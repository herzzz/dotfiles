...
## Type: Font
c.fonts.monospace = '"Fira Code", Inconsolata, "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
## Type: Dict
c.url.searchengines = {"g": "https://www.google.com/search?q={}", 'DEFAULT': 'https://duckduckgo.com/?q={}'}
